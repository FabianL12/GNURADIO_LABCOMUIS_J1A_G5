...
class prueba_bloque_potencia(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "prueba_bloque_potencia", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("prueba_bloque_potencia")
        ...
        self.settings = Qt.QSettings("GNU Radio", "prueba_bloque_potencia")
        ...
        # Blocks
        ##################################################
        self._A_range = Range(0, 50, 1, 1, 200)
        ...
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_SAW_WAVE, 2000, A, 0, 0)
...
def main(top_block_cls=prueba_bloque_potencia, options=None):
